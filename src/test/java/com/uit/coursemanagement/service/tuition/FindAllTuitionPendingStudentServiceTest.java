...
@SpringBootTest
public class FindAllTuitionPendingStudentServiceTest {
    ...
    public void execute_UTCID01_SemesterNotFound_ExceptionFail() {
        ...
        var input = new IFindAllTuitionPendingStudentService.Input(semester.getId(), fullName);
        Assertions.assertThrows(NotFoundException.class, () -> findAllTuitionPendingStudentService.execute(input));
    }
    ...
    public void execute_UTCID010_GoodInput_Success() {
        ...
        var input = new IFindAllTuitionPendingStudentService.Input(semester.getId(), fullName);
        Assertions.assertNotNull(findAllTuitionPendingStudentService.execute(input));
    }
